...
<body>
    <div class="container">
        <div id="margin">
            ...
            <form id="page1Form" method="post" action="save_freundebuch.php">
                <div class="section1">
                    <h1 id="Überschrift">Das bin ich:</h1>                
                    <input type="file">
                    <label class="inputVerschieben">Name:    <input class="mittig" type="text" name="name" placeholder="Gebe deinen Namen ein"></label><br>
                    <label class="inputVerschieben">Alter:   <input class="mittig" type="number" name="age" placeholder="Gebe dein Alter ein"></label><br>
                    <label class="inputVerschieben">Beruf:   <input class="mittig" type="text" name="job" placeholder="Gebe deinen Beruf ein"></label><br>
                ...
                <div class="container">
                    ...
                    <button id="button" type="submit">Abschicken</button><br>
                </div>
            </form>
        </div>
    </div>
